...
```bash
# 프로젝트 디렉토리 생성
mkdir -p fashion-trend-board/{backend/{db,crawlers/brand_crawlers,signals,api/routes,importers},frontend/src/{components,hooks,utils,styles},data/{vlm,celeb,imports,exports},scripts}
